 ...
 */
export const canUserCreateArtists = canUserCreateProfiles;
export const artistEditableByUser = profileEditableByUser;
export const artistBelongsToLoggedInUser = profileBelongsToLoggedInUser;
