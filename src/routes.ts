...
const routes = [
  ...
  "artists/{id}/unfollow",
  "artists/{id}/remoteFollow",
  "artists/{id}/contact",
  "artists/{id}/redeemCode",
  ...
  "users/{userId}/notifications/{notificationId}/reportSpam",
  ...
  "manage/artists/{artistId}/images/{imageId}",
  ...
  "manage/sales",
  "manage/sales/{transactionId}/resendReceipt",
  "manage/tracks",
